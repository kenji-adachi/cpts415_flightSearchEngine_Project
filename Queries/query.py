...
def airline_country_search(country_name):
    ...
    airlineQuery = airline_collection.distinct( "AIRLINE_ID", { "ACTIVE" : "Y", "COUNTRY" : country_name } ) 
...
def airport_country_search(country_name):
    ...
    airportQuery = airport_collection.distinct( "AIRPORT_ID", { "COUNTRY" : country_name } )
...
def airport_city_search(city_name):
    ...
    airportQuery = airport_collection.distinct( "AIRPORT_ID", { "CITY" : city_name } )
...
# Return list of all valid city names
def city_names():
    city_list = []
...
# Return list of all valid city names given a country name
...
def route_stop_search(stop_count):
    route_list = []

    #routeQuery = route_collection.distinct(  )
...
def main():
    ...
    #print(country_names())
    #print(city_names())
    print(city_names_with_country(country_name))
